...
import { Activity, Globe2, List, ListTree, Settings2, Shield, Zap } from 'lucide-react';
import { Panel, Metric } from '../ui';
import { api } from '../../services/api';
import { readError, formatDelay, resolveConcreteNode, routeLabel } from '../../utils/helpers';
import type { ProxyNode, RuntimeRule } from '../../types';

export function Topology({ setBusy }: { setBusy: (busy: boolean) => void }) {
